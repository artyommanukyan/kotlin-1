...
fun <T : _InterfaceWithTypeParameter1<in T>> case_24(x: _InterfaceWithTypeParameter1<T>?) {
    if (x != null) {
        ...
        <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<T>? & _InterfaceWithTypeParameter1<T>"), DEBUG_INFO_SMARTCAST!>x<!>.ip1test1()
...
fun <T : _InterfaceWithTypeParameter1<T>> case_26(x: _InterfaceWithTypeParameter1<in T>?) {
    if (x != null) {
        ...
        <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<in T> & _InterfaceWithTypeParameter1<in T>?")!>x<!>.ip1test1()
...
fun <T : _InterfaceWithTypeParameter1<T>> case_27(x: _InterfaceWithTypeParameter1<out T>?) {
    if (x != null) {
        ...
        <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<out T> & _InterfaceWithTypeParameter1<out T>?")!>x<!>.ip1test1()
