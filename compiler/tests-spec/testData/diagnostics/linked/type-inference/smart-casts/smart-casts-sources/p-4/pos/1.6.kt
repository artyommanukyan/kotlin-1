...
fun case_73(t: Any?) {
    ...
    if (t is _Interface2?) {
        if (t is ClassLevel1?) {
            if (t is ClassLevel2? && t is _Interface1?) {
                if (t !is _Interface3?) {} else if (false) {
                    if (t != <!DEBUG_INFO_CONSTANT!>`null`<!>) {
                        ...
                        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any? & ClassLevel1"), DEBUG_INFO_SMARTCAST!>t<!>.test1()
                        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any? & ClassLevel2"), DEBUG_INFO_SMARTCAST!>t<!>.test2()
                        <!DEBUG_INFO_EXPRESSION_TYPE("ClassLevel1 & ClassLevel2 & _Interface1 & _Interface2 & _Interface3 & kotlin.Any & kotlin.Any?")!>t<!>
                    }
                }
            }
        }
    ...
    if (t !is ClassLevel2? || <!USELESS_IS_CHECK!>t !is ClassLevel1?<!>) else {
        if (t === ((((((<!DEBUG_INFO_CONSTANT!>z<!>)))))) || t !is _Interface1?) else {
            if (t !is _Interface2? || t !is _Interface3?) {} else {
                ...
                <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any? & _Interface1"), DEBUG_INFO_SMARTCAST!>t<!>.itest1()
                <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any? & _Interface3"), DEBUG_INFO_SMARTCAST!>t<!>.itest()
                <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any? & ClassLevel2"), DEBUG_INFO_SMARTCAST!>t<!>.test1()
                <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any? & ClassLevel2"), DEBUG_INFO_SMARTCAST!>t<!>.test2()
                <!DEBUG_INFO_EXPRESSION_TYPE("ClassLevel1 & ClassLevel2 & _Interface1 & _Interface2 & _Interface3 & kotlin.Any & kotlin.Any?"), DEBUG_INFO_SMARTCAST!>t<!>
            }
        }
    }
}
