...
fun <T : _InterfaceWithTypeParameter1<in T>> _InterfaceWithTypeParameter1<T>?.case_24() {
    if (this != null) {
        ...
        <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<T>"), DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<T>?"), DEBUG_INFO_SMARTCAST!>this<!>.ip1test1()
        ...
        <!DEBUG_INFO_IMPLICIT_RECEIVER_SMARTCAST!>apply<!> {
            ...
            <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<T>"), DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<T>")!>this<!>.ip1test1()
        }
        <!DEBUG_INFO_IMPLICIT_RECEIVER_SMARTCAST!>also<!> {
            ...
            <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<T>")!>it<!>.ip1test1()
        }
    }
}
...
fun <T : _InterfaceWithTypeParameter1<T>> _InterfaceWithTypeParameter1<in T>?.case_26() {
    if (this != null) {
        ...
        <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<in T> & _InterfaceWithTypeParameter1<in T>?"), DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<in T>?")!>this<!>.ip1test1()
        ...
        apply {
            ...
            <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<in T>"), DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<in T>")!>this<!>.ip1test1()
        }
        also {
            ...
            <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<in T>")!>it<!>.ip1test1()
        }
    }
}
...
fun <T : _InterfaceWithTypeParameter1<T>> _InterfaceWithTypeParameter1<out T>?.case_27() {
    if (this != null) {
        ...
        <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<out T> & _InterfaceWithTypeParameter1<out T>?"), DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<out T>?")!>this<!>.ip1test1()
        ...
        apply {
            ...
            <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<out T>"), DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<out T>")!>this<!>.ip1test1()
        }
        also {
            ...
            <!DEBUG_INFO_EXPRESSION_TYPE("_InterfaceWithTypeParameter1<out T>")!>it<!>.ip1test1()
        }
    }
}
